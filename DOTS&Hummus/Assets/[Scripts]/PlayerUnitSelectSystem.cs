...
public class PlayerUnitSelectSystem : JobComponentSystem
{
    ...
    struct PlayerUnitSelectJob : IJobForEachWithEntity<PlayerInputComponent, AABB>
    {
        ...
        public void Execute
            (Entity entity, int index, [ReadOnly] ref PlayerInputComponent inputComponent, [ReadOnly] ref AABB aabb)
        {
